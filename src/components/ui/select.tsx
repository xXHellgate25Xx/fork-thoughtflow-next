    ...
    <SelectPrimitive.Portal>
        ...
        >
            <SelectPrimitive.Viewport
                className={cn(
                    "p-1 overflow-y-auto max-h-[400px] [scrollbar-width:thin] [&::-webkit-scrollbar]:block [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-300",
                    position === "popper" &&
